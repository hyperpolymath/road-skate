...
= Dev Container Usage
:author: hyperpolymath <j.d.a.jewell@open.ac.uk>
...
Replace `AffineScript-Vite` placeholders in both `devcontainer.json` and `Containerfile` with your actual project name. Run `just deps` to verify the environment after first launch.
