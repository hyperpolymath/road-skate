...
#
# Nix flake for AffineScript-Vite
#
...
#
# TODO: Replace AffineScript-Vite and {{PROJECT_DESCRIPTION}} with actual values.

{
  description = "AffineScript-Vite — RSR-compliant project";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            if [ -z "''${DIRENV_IN_ENVRC:-}" ] && [ -f .envrc ]; then
              ...
              export PROJECT_NAME="AffineScript-Vite"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            echo "TODO: Add build commands for AffineScript-Vite"
          '';
          ...
          meta = with pkgs.lib; {
            ...
            homepage = "https://github.com/hyperpolymath/AffineScript-Vite";
